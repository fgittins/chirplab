...
class Interferometer:
    ...
    def __init__(
        ...
        self.rho: None | numpy.float64 = None
        self.rho_MF: None | numpy.complex128 = None
    ...
    def inject(self, model: waveform.WaveformModel, Theta: waveform.SignalParameters) -> None:
        ...
        self.rho = self.calculate_inner_product(self.h_tilde, self.h_tilde).real ** (1 / 2)
        self.rho_MF = self.calculate_inner_product(self.h_tilde, self.d_tilde) / self.rho
